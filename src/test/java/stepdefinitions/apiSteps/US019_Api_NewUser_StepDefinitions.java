 ...
 */
    ...
    @And("AdminOki sends the post request with token and gets the response and then validates")
        ...
        Assert.assertEquals(createNewUser.getLogin(), actualData.get("login").toString() );
        Assert.assertEquals(createNewUser.getFirstName(), actualData.get("firstName").toString() );
        Assert.assertEquals(createNewUser.getLastName(), actualData.get("lastName").toString() );
        Assert.assertEquals(createNewUser.getEmail(), actualData.get("email").toString() );
